...
},{"./put_on_chan":7,"immutable":106,"underscore":107}],4:[function(require,module,exports){
"use strict";
...
var patrol = function patrol(stateDescriptor) {
  ...
  each(dataStore, function (conf, path) {
    if (conf.fetcher && conf.initialFetch !== false) {
      conf.fetcher(setCh, path, (0, _get_state_by_path2['default'])(currentState, path));
    }
  });
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        ...
        case 3:
          ...
          if (persister) {
            persister(setCh, path, (0, _get_state_by_path2['default'])(currentState, path), changes.pop(), currentState);
          }
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        ...
        case 3:
          ...
          if (fetcher) {
            fetcher(setCh, path, (0, _get_state_by_path2['default'])(currentState, path));
          }
          context$2$0.next = 0;
          break;
...
},{"../vendor/js-csp":109,"./build_updated_state":2,"./cursor":3,"./find_closest_transmitter":4,"./get_state_by_path":5,"./put_on_chan":7,"./remove_state_at_path":8,"immutable":106,"underscore":107}],7:[function(require,module,exports){
"use strict";
...
},{"../vendor/js-csp":109}],8:[function(require,module,exports){
'use strict';
...
},{"./get_state_by_path":5,"./patrol":6}],10:[function(require,module,exports){
