...
},{"./lib/state_trooper":9,"babel/register":104}],2:[function(require,module,exports){
"use strict";
...
function applyStateChange(state, change) {
  ...
  switch (action) {
    case "set":
      if (path.length) return state.mergeIn(path, value);else return value;
    case "add":
      var list = state.getIn(path).push(value);
      return state.setIn(path, list);
    case "remove":
      return state.removeIn(path);
    case "replace":
      if (path.length) return state.setIn(path, value);else return value;
  }
}

exports["default"] = applyStateChange;
module.exports = exports["default"];
...
function replace(ch, path, value) {
  mutate(ch, { path: path, value: _immutable2['default'].fromJS(value), action: 'replace' });
}

function set(ch, path, value) {
  mutate(ch, { path: path, value: _immutable2['default'].fromJS(value), action: 'set' });
}

function add(ch, path, value) {
  mutate(ch, { path: path, value: _immutable2['default'].fromJS(value), action: 'add' });
}

function remove(ch, path, value) {
  mutate(ch, { path: path, value: value, action: 'remove' });
}

function mutate(ch, change) {
  (0, _put_on_chan2['default'])(ch, change);
}

// refining
function refine(value, mutateCh, fetchCh, persistCh, oldPath, newPath) {
  var newPathArr = (0, _underscore.isArray)(newPath) ? newPath : newPath.toString().split('.');
  var refinedValue = value.getIn(newPathArr);
  var refinedPath = oldPath.concat(newPathArr);
...
var cursor = function cursor(value, path, mutateCh, fetchCh, persistCh) {
  ...
  var o = {
    ...
    replace: (0, _underscore.partial)(replace, mutateCh, path),
    remove: (0, _underscore.partial)(remove, mutateCh, path, imVal),

    refine: (0, _underscore.partial)(refine, imVal, mutateCh, fetchCh, persistCh, path),
  ...
  if (_immutable2['default'].List.isList(imVal)) {
    ...
    o.add = (0, _underscore.partial)(add, mutateCh, path);
  }
  if (_immutable2['default'].Map.isMap(imVal)) {
    o.set = (0, _underscore.partial)(set, mutateCh, path);
  }
...
},{"./convert_to_native":3,"./put_on_chan":8,"immutable":106,"underscore":107}],5:[function(require,module,exports){
"use strict";
...
var findClosestTransmitter = function findClosestTransmitter(type, dataStore, path) {
  ...
  if (!dataStore) {
    throw new Error("Couldn't find " + type + " for " + pathStr + "with no data store");
  }
...
var getStateByPath = function getStateByPath(state, path) {
  ...
  return imVal.getIn((0, _underscore.isArray)(path) ? path : path.split('.'));
};

exports['default'] = getStateByPath;
module.exports = exports['default'];

},{"immutable":106,"underscore":107}],7:[function(require,module,exports){
'use strict';
...
var _apply_state_change = require('./apply_state_change');

var _apply_state_change2 = _interopRequireDefault(_apply_state_change);
...
var patrol = function patrol(stateDescriptor) {
  ...
  var mutateCh = (0, _vendorJsCsp.chan)();
  var persistCh = (0, _vendorJsCsp.chan)();
  var fetchCh = (0, _vendorJsCsp.chan)();
  var createCursor = partial(_cursor2['default'], _underscore2['default'], [], mutateCh, fetchCh, persistCh);

  var currentState = _immutable2['default'].fromJS(stateDescriptor.state);
  var rootCursor = createCursor(currentState);
  var unpersistedChanges = [];
  ...
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        ...
        case 1:
          context$2$0.next = 3;
          return (0, _vendorJsCsp.take)(mutateCh);

        case 3:
          if (!(change = context$2$0.sent)) {
            context$2$0.next = 10;
            break;
          }

          unpersistedChanges.push(change);
          currentState = (0, _apply_state_change2['default'])(currentState, change);
          rootCursor = createCursor(currentState);
          (0, _put_on_chan2['default'])(mainCursorCh, rootCursor);
          context$2$0.next = 1;
          break;
...
},{"../vendor/js-csp":109,"./apply_state_change":2,"./convert_to_native":3,"./cursor":4,"./find_closest_transmitter":5,"./get_state_by_path":6,"./put_on_chan":8,"immutable":106,"underscore":107}],8:[function(require,module,exports){
"use strict";
...
},{"../vendor/js-csp":109}],9:[function(require,module,exports){
'use strict';
...
},{"./get_state_by_path":6,"./patrol":7}],10:[function(require,module,exports){
...
module.exports = exports["default"];
},{"../../polyfill":12}],11:[function(require,module,exports){
"use strict";
...
module.exports = exports["default"];
},{"../../polyfill":12,"./node":10}],12:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":101,"regenerator/runtime":102}],13:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
},{"./lib/babel/api/register/node-polyfill":11}],104:[function(require,module,exports){
module.exports = require("babel-core/register");

},{"babel-core/register":103}],105:[function(require,module,exports){
...
},{"./impl/buffers":112,"./impl/channels":113,"./impl/process":115,"./impl/select":116,"./impl/timers":117}],109:[function(require,module,exports){
"use strict";
...
},{"./csp.core":108,"./csp.operations":110,"./csp.pipeline":111}],110:[function(require,module,exports){
"use strict";
...
},{"./csp.core":108,"./impl/channels":113}],111:[function(require,module,exports){
'use strict';
...
},{"./csp.core":108}],112:[function(require,module,exports){
"use strict";
...
},{"./buffers":112,"./dispatch":114}],114:[function(require,module,exports){
"use strict";
...
},{"./buffers":112}],115:[function(require,module,exports){
"use strict";
...
},{"./channels":113,"./dispatch":114,"./select":116}],116:[function(require,module,exports){
"use strict";
...
},{"./channels":113}],117:[function(require,module,exports){
"use strict";
