...
var buildUpdatedState = function buildUpdatedState(oldState, pathToNewState, newState) {
  if (pathToNewState) {
    var changedState = (0, _clone2['default'])(oldState);
    _objectPath2['default'].set(changedState, pathToNewState, newState);
    return changedState;
  } else {
    return (0, _clone2['default'])(newState);
  }
};
...
},{"clone":110,"object-path":111}],3:[function(require,module,exports){
'use strict';
...
var refine = function refine(value, setCh, removeCh, fetchCh, persistCh, oldPath, newPath) {
  var refinedValue = _objectPath2['default'].get(value, newPath);
...
var set = function set(ch, path, oldValue, newValue) {
  ...
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
          return (0, _vendorJsCsp.put)(ch, { path: path, value: newValue });
...
var persist = function persist(ch, path) {
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
          return (0, _vendorJsCsp.put)(ch, path);
...
var fetch = function fetch(ch, path) {
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
  ...
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
          return (0, _vendorJsCsp.put)(removeCh, { path: path, value: value });
...
var cursor = function cursor(value, path, setCh, removeCh, fetchCh, persistCh) {
  return {
    path: path,
    value: value,
    set: (0, _underscore.partial)(set, setCh, path, value),
    remove: (0, _underscore.partial)(remove, removeCh, path, value),
    refine: (0, _underscore.partial)(refine, value, setCh, removeCh, fetchCh, persistCh, path),
    persist: (0, _underscore.partial)(persist, persistCh, path),
    fetch: (0, _underscore.partial)(fetch, fetchCh, path)
  };
};
...
},{"../vendor/js-csp":114,"object-path":111,"underscore":112}],4:[function(require,module,exports){
"use strict";
...
var getStateByPath = function getStateByPath(state, path) {
  return _objectPath2['default'].get(state, path);
};

exports['default'] = getStateByPath;
module.exports = exports['default'];

},{"object-path":111}],6:[function(require,module,exports){
'use strict';
...
var _put_cursor_on_chan = require('./put_cursor_on_chan');

var _put_cursor_on_chan2 = _interopRequireDefault(_put_cursor_on_chan);
...
var patrol = function patrol(stateDescriptor) {
  var currentState = (0, _clone2['default'])(stateDescriptor.state);
  ...
  (0, _put_cursor_on_chan2['default'])(mainCursorCh, createCursor(currentState));
...
},{"../vendor/js-csp":114,"./build_updated_state":2,"./cursor":3,"./find_closest_transmitter":4,"./get_state_by_path":5,"./put_cursor_on_chan":7,"./remove_state_at_path":8,"clone":110,"underscore":112}],7:[function(require,module,exports){
"use strict";
...
var putCursorOnChan = function putCursorOnChan(ch, cur) {
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
          return (0, _vendorJsCsp.put)(ch, cur);
...
exports["default"] = putCursorOnChan;
module.exports = exports["default"];

},{"../vendor/js-csp":114}],8:[function(require,module,exports){
'use strict';
...
var removeStateAtPath = function removeStateAtPath(oldState, path) {
  var clonedState = (0, _clone2['default'])(oldState);
  _objectPath2['default'].del(clonedState, path);
  return clonedState;
};
...
},{"clone":110,"object-path":111}],9:[function(require,module,exports){
'use strict';
...
},{"_process":109}],103:[function(require,module,exports){
...
},{"./impl/buffers":117,"./impl/channels":118,"./impl/process":120,"./impl/select":121,"./impl/timers":122}],114:[function(require,module,exports){
"use strict";
...
},{"./csp.core":113,"./csp.operations":115,"./csp.pipeline":116}],115:[function(require,module,exports){
"use strict";
...
},{"./csp.core":113,"./impl/channels":118}],116:[function(require,module,exports){
'use strict';
...
},{"./csp.core":113}],117:[function(require,module,exports){
"use strict";
...
},{"./buffers":117,"./dispatch":119}],119:[function(require,module,exports){
"use strict";
...
},{"./buffers":117}],120:[function(require,module,exports){
"use strict";
...
},{"./channels":118,"./dispatch":119,"./select":121}],121:[function(require,module,exports){
"use strict";
...
},{"./channels":118}],122:[function(require,module,exports){
"use strict";
