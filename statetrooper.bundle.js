...
var _libState_trooper = require("./lib/state_trooper");

var _libState_trooper2 = _interopRequireDefault(_libState_trooper);

require("babel/register");

if (window) {
  window.StateTrooper = _libState_trooper2["default"];
}

exports["default"] = _libState_trooper2["default"];
module.exports = exports["default"];

},{"./lib/state_trooper":10,"babel/register":105}],2:[function(require,module,exports){
'use strict';
...
var convertToNative = function convertToNative(value) {
  return value && typeof value.toJS === 'function' ? value.toJS() : value;
};

exports['default'] = convertToNative;
module.exports = exports['default'];
...
var _convert_to_native = require('./convert_to_native');

var _convert_to_native2 = _interopRequireDefault(_convert_to_native);

var _immutable = require('immutable');

var _immutable2 = _interopRequireDefault(_immutable);

var _put_on_chan = require('./put_on_chan');

var _put_on_chan2 = _interopRequireDefault(_put_on_chan);

var hasSameValue = function hasSameValue(valueA, cursorB) {
  return isEqual(valueA, _immutable2['default'].fromJS(cursorB.deref()));
};

var isEqual = function isEqual(valueA, valueB) {
  if (valueA) {
    return _immutable2['default'].is(valueA, valueB);
  } else {
...
var deref = function deref(value) {
  return (0, _convert_to_native2['default'])(value);
};
...
// "mutations"
var replace = function replace(ch, path, oldValue, newValue) {
  putOnChanIfChanged(ch, path, oldValue, _immutable2['default'].fromJS(newValue));
};
...
var remove = function remove(removeCh, path, value) {
  (0, _put_on_chan2['default'])(removeCh, { path: path, value: value });
};
...
// array helpers
var cMap = function cMap(value, mapper) {
  return value.map(function (v, i) {
    return mapper(cursor.refine(i), i);
  });
};
...
var cursor = function cursor(value, path, setCh, removeCh, fetchCh, persistCh) {
  ...
  var o = {
    path: path,
    deref: (0, _underscore.partial)(deref, imVal),

    replace: (0, _underscore.partial)(replace, setCh, path, imVal),
    remove: (0, _underscore.partial)(remove, removeCh, path, imVal),

    refine: (0, _underscore.partial)(refine, imVal, setCh, removeCh, fetchCh, persistCh, path),

    persist: (0, _underscore.partial)(_put_on_chan2['default'], persistCh, path),
    fetch: (0, _underscore.partial)(_put_on_chan2['default'], fetchCh, path),

    hasSameValue: (0, _underscore.partial)(hasSameValue, imVal)
  };

  if (_immutable2['default'].List.isList(imVal)) {
    // array specific operations
    o.map = (0, _underscore.partial)(cMap, imVal);
    o.add = (0, _underscore.partial)(add, setCh, path, imVal);
  }
  if (_immutable2['default'].Map.isMap(imVal)) {
    o.set = (0, _underscore.partial)(set, setCh, path, imVal);
  }
...
},{"./convert_to_native":3,"./put_on_chan":8,"immutable":107,"underscore":108}],5:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
var findClosestTransmitter = function findClosestTransmitter(type, dataStore, path) {
...
exports["default"] = findClosestTransmitter;
module.exports = exports["default"];
...
},{"immutable":107}],7:[function(require,module,exports){
'use strict';
...
var _vendorJsCsp = require('../vendor/js-csp');
...
var _build_updated_state = require('./build_updated_state');

var _build_updated_state2 = _interopRequireDefault(_build_updated_state);

var _remove_state_at_path = require('./remove_state_at_path');

var _remove_state_at_path2 = _interopRequireDefault(_remove_state_at_path);

var _get_state_by_path = require('./get_state_by_path');

var _get_state_by_path2 = _interopRequireDefault(_get_state_by_path);

var _find_closest_transmitter = require('./find_closest_transmitter');

var _find_closest_transmitter2 = _interopRequireDefault(_find_closest_transmitter);

var each = _underscore2['default'].each;
var partial = _underscore2['default'].partial;

var findClosestPersister = partial(_find_closest_transmitter2['default'], 'persister');
var findClosestFetcher = partial(_find_closest_transmitter2['default'], 'fetcher');

var patrol = function patrol(stateDescriptor) {
  var currentState = _immutable2['default'].fromJS(stateDescriptor.state);
  var dataStore = stateDescriptor.dataStore;

  var mainCursorCh = (0, _vendorJsCsp.chan)();

  var setCh = (0, _vendorJsCsp.chan)();
  var removeCh = (0, _vendorJsCsp.chan)();
  var persistCh = (0, _vendorJsCsp.chan)();
  var fetchCh = (0, _vendorJsCsp.chan)();
  var createCursor = partial(_cursor2['default'], _underscore2['default'], '', setCh, removeCh, fetchCh, persistCh);

  var changes = [];

  // put initial blank cursor
  (0, _put_on_chan2['default'])(mainCursorCh, createCursor(currentState));

  // fetch initial data
  each(dataStore, function (conf, path) {
    if (conf.fetcher && conf.initialFetch !== false) {
      conf.fetcher(setCh, path, (0, _convert_to_native2['default'])((0, _get_state_by_path2['default'])(currentState, path)));
    }
  });

  // react to any new data on the set channel
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    var change;
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          ...
          context$2$0.next = 3;
          return (0, _vendorJsCsp.take)(setCh);

        case 3:
          change = context$2$0.sent;

          changes.push({ action: 'set', path: change.path, value: change.value });
          currentState = (0, _build_updated_state2['default'])(currentState, change.path, change.value);
          (0, _put_on_chan2['default'])(mainCursorCh, createCursor(currentState));
          context$2$0.next = 0;
          break;
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          ...
          context$2$0.next = 3;
          return (0, _vendorJsCsp.take)(removeCh);

        case 3:
          change = context$2$0.sent;

          changes.push({ action: 'remove', path: change.path, value: change.value });
          currentState = (0, _remove_state_at_path2['default'])(currentState, change.path);
          (0, _put_on_chan2['default'])(mainCursorCh, createCursor(currentState));
          context$2$0.next = 0;
          break;
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          ...
          context$2$0.next = 3;
          return (0, _vendorJsCsp.take)(persistCh);

        case 3:
          path = context$2$0.sent;
          persister = findClosestPersister(dataStore, path);

          if (persister) {
            persister(setCh, path, (0, _convert_to_native2['default'])((0, _get_state_by_path2['default'])(currentState, path)), changes.pop(), currentState);
          }
    ...
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          ...
          context$2$0.next = 3;
          return (0, _vendorJsCsp.take)(fetchCh);

        case 3:
          path = context$2$0.sent;
          fetcher = findClosestFetcher(dataStore, path);

          if (fetcher) {
            fetcher(setCh, path, (0, _convert_to_native2['default'])((0, _get_state_by_path2['default'])(currentState, path)));
          }
          context$2$0.next = 0;
          break;
...
},{"../vendor/js-csp":110,"./build_updated_state":2,"./convert_to_native":3,"./cursor":4,"./find_closest_transmitter":5,"./get_state_by_path":6,"./put_on_chan":8,"./remove_state_at_path":9,"immutable":107,"underscore":108}],8:[function(require,module,exports){
"use strict";
...
var putOnChan = function putOnChan(ch, value) {
  (0, _vendorJsCsp.go)(regeneratorRuntime.mark(function callee$1$0() {
    return regeneratorRuntime.wrap(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          context$2$0.next = 2;
          return (0, _vendorJsCsp.put)(ch, value);
...
exports["default"] = putOnChan;
module.exports = exports["default"];

},{"../vendor/js-csp":110}],9:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, '__esModule', {
  value: true
});
var removeStateAtPath = function removeStateAtPath(oldState, path) {
  return oldState.removeIn(path.split('.'));
};

exports['default'] = removeStateAtPath;
module.exports = exports['default'];
...
var _patrol = require('./patrol');

var _patrol2 = _interopRequireDefault(_patrol);

var StateTrooper = {
  getStateByPath: _get_state_by_path2['default'],
  patrol: _patrol2['default']
};

exports['default'] = StateTrooper;
module.exports = exports['default'];

},{"./get_state_by_path":6,"./patrol":7}],11:[function(require,module,exports){
...
module.exports = exports["default"];
},{"../../polyfill":13}],12:[function(require,module,exports){
"use strict";
...
module.exports = exports["default"];
},{"../../polyfill":13,"./node":11}],13:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/shim":102,"regenerator/runtime":103}],14:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
var $ = require('./$');
...
},{"./$":35}],15:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./$":35,"./$.ctx":23}],16:[function(require,module,exports){
var $ = require('./$');
...
},{"./$":35}],17:[function(require,module,exports){
var $        = require('./$')
...
},{"./$":35,"./$.enum-keys":26}],18:[function(require,module,exports){
var $        = require('./$')
...
module.exports = cof;
},{"./$":35,"./$.wks":53}],19:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
...
},{"./$":35,"./$.assert":16,"./$.ctx":23,"./$.for-of":27,"./$.iter":34,"./$.iter-define":32,"./$.mix":37,"./$.uid":51}],20:[function(require,module,exports){
...
},{"./$":35,"./$.array-methods":15,"./$.assert":16,"./$.for-of":27,"./$.mix":37,"./$.uid":51}],22:[function(require,module,exports){
'use strict';
var $     = require('./$')
  , $def  = require('./$.def')
...
},{"./$":35,"./$.assert":16,"./$.cof":18,"./$.def":24,"./$.for-of":27,"./$.iter":34,"./$.iter-detect":33,"./$.mix":37,"./$.redef":40,"./$.species":45}],23:[function(require,module,exports){
...
module.exports = $def;
},{"./$":35,"./$.redef":40}],25:[function(require,module,exports){
var $        = require('./$')
  , document = $.g.document
  , isObject = $.isObject
...
},{"./$.ctx":23,"./$.iter":34,"./$.iter-call":31}],28:[function(require,module,exports){
...
},{"./$":35,"./$.cof":18,"./$.def":24,"./$.iter":34,"./$.redef":40,"./$.wks":53}],33:[function(require,module,exports){
...
},{"./$.wks":53}],34:[function(require,module,exports){
'use strict';
var $                 = require('./$')
  , cof               = require('./$.cof')
  , classof           = cof.classof
...
},{"./$":35,"./$.assert":16,"./$.cof":18,"./$.shared":44,"./$.wks":53}],35:[function(require,module,exports){
'use strict';
...
},{"./$.fw":28}],36:[function(require,module,exports){
var $ = require('./$');
...
},{"./$.redef":40}],38:[function(require,module,exports){
var $            = require('./$')
...
},{"./$":35,"./$.assert":16}],39:[function(require,module,exports){
'use strict';
var $      = require('./$')
...
},{"./$":35,"./$.assert":16,"./$.invoke":30}],40:[function(require,module,exports){
var $   = require('./$')
...
},{"./$":35,"./$.uid":51}],41:[function(require,module,exports){
'use strict';
...
},{"./$":35,"./$.assert":16,"./$.ctx":23}],44:[function(require,module,exports){
var $      = require('./$')
...
},{"./$":35}],45:[function(require,module,exports){
var $       = require('./$')
...
},{"./$":35,"./$.wks":53}],46:[function(require,module,exports){
// true  -> String#at
...
},{"./$":35}],47:[function(require,module,exports){
...
},{"./$":35,"./$.string-repeat":48}],48:[function(require,module,exports){
'use strict';
var $ = require('./$');
...
},{"./$":35}],49:[function(require,module,exports){
'use strict';
var $      = require('./$')
  , ctx    = require('./$.ctx')
  , cof    = require('./$.cof')
...
},{"./$":35,"./$.cof":18,"./$.ctx":23,"./$.dom-create":25,"./$.invoke":30}],50:[function(require,module,exports){
module.exports = function(exec){
  try {
    exec();
    return false;
...
module.exports = uid;
},{"./$":35}],52:[function(require,module,exports){
...
},{"./$":35,"./$.wks":53}],53:[function(require,module,exports){
...
},{"./$":35,"./$.shared":44,"./$.uid":51}],54:[function(require,module,exports){
var $                = require('./$')
  , cel              = require('./$.dom-create')
  , cof              = require('./$.cof')
  , $def             = require('./$.def')
...
},{"./$":35,"./$.array-includes":14,"./$.array-methods":15,"./$.assert":16,"./$.cof":18,"./$.def":24,"./$.dom-create":25,"./$.invoke":30,"./$.replacer":41,"./$.throws":50,"./$.uid":51}],55:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":35,"./$.def":24,"./$.unscope":52}],56:[function(require,module,exports){
'use strict';
var $       = require('./$')
  , $def    = require('./$.def')
  , toIndex = $.toIndex;
...
},{"./$":35,"./$.def":24,"./$.unscope":52}],57:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":15,"./$.def":24,"./$.unscope":52}],58:[function(require,module,exports){
'use strict';
...
require('./$.unscope')(KEY);
},{"./$.array-methods":15,"./$.def":24,"./$.unscope":52}],59:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":35,"./$.ctx":23,"./$.def":24,"./$.iter":34,"./$.iter-call":31,"./$.iter-detect":33}],60:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":35,"./$.iter":34,"./$.iter-define":32,"./$.uid":51,"./$.unscope":52}],61:[function(require,module,exports){
var $def = require('./$.def');
$def($def.S, 'Array', {
...
},{"./$.species":45}],63:[function(require,module,exports){
var $             = require('./$')
...
},{"./$":35,"./$.wks":53}],64:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , NAME = 'name'
  , setDesc = $.setDesc
...
},{"./$":35}],65:[function(require,module,exports){
'use strict';
...
},{"./$.collection":22,"./$.collection-strong":19}],66:[function(require,module,exports){
var Infinity = 1 / 0
  , $def  = require('./$.def')
  , E     = Math.E
  , pow   = Math.pow
...
},{"./$.def":24}],67:[function(require,module,exports){
'use strict';
var $          = require('./$')
  , isObject   = $.isObject
  , isFunction = $.isFunction
...
},{"./$":35,"./$.redef":40}],68:[function(require,module,exports){
var $     = require('./$')
  , $def  = require('./$.def')
  , abs   = Math.abs
  , floor = Math.floor
...
},{"./$":35,"./$.def":24}],69:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $def = require('./$.def');
$def($def.S, 'Object', {assign: require('./$.assign')});
},{"./$.assign":17,"./$.def":24}],70:[function(require,module,exports){
// 19.1.3.10 Object.is(value1, value2)
var $def = require('./$.def');
$def($def.S, 'Object', {
  is: require('./$.same')
});
},{"./$.def":24,"./$.same":42}],71:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $def = require('./$.def');
$def($def.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.def":24,"./$.set-proto":43}],72:[function(require,module,exports){
var $        = require('./$')
  , $def     = require('./$.def')
  , isObject = $.isObject
  , toObject = $.toObject;
...
},{"./$":35,"./$.def":24,"./$.get-names":29}],73:[function(require,module,exports){
'use strict';
...
},{"./$":35,"./$.cof":18,"./$.redef":40,"./$.wks":53}],74:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
  , cof      = require('./$.cof')
...
},{"./$":35,"./$.assert":16,"./$.cof":18,"./$.ctx":23,"./$.def":24,"./$.for-of":27,"./$.iter-detect":33,"./$.mix":37,"./$.same":42,"./$.set-proto":43,"./$.species":45,"./$.task":49,"./$.uid":51,"./$.wks":53}],75:[function(require,module,exports){
var $         = require('./$')
  , $def      = require('./$.def')
...
},{"./$":35,"./$.assert":16,"./$.def":24,"./$.iter":34,"./$.own-keys":38,"./$.set-proto":43,"./$.uid":51,"./$.wks":53}],76:[function(require,module,exports){
var $       = require('./$')
  , cof     = require('./$.cof')
  , $RegExp = $.g.RegExp
  , Base    = $RegExp
...
},{"./$":35,"./$.cof":18,"./$.redef":40,"./$.replacer":41,"./$.species":45}],77:[function(require,module,exports){
'use strict';
var strong = require('./$.collection-strong');
...
},{"./$.collection":22,"./$.collection-strong":19}],78:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":24,"./$.string-at":46}],79:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def')
...
},{"./$":35,"./$.cof":18,"./$.def":24,"./$.throws":50}],80:[function(require,module,exports){
var $def    = require('./$.def')
...
},{"./$":35,"./$.def":24}],81:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":35,"./$.cof":18,"./$.def":24}],82:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":35,"./$.iter":34,"./$.iter-define":32,"./$.string-at":46,"./$.uid":51}],83:[function(require,module,exports){
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":35,"./$.def":24}],84:[function(require,module,exports){
var $def = require('./$.def');
...
},{"./$.def":24,"./$.string-repeat":48}],85:[function(require,module,exports){
'use strict';
var $    = require('./$')
  , cof  = require('./$.cof')
  , $def = require('./$.def');
...
},{"./$":35,"./$.cof":18,"./$.def":24,"./$.throws":50}],86:[function(require,module,exports){
'use strict';
...
},{"./$":35,"./$.assert":16,"./$.cof":18,"./$.def":24,"./$.enum-keys":26,"./$.get-names":29,"./$.keyof":36,"./$.redef":40,"./$.shared":44,"./$.uid":51,"./$.wks":53}],87:[function(require,module,exports){
'use strict';
var $         = require('./$')
...
},{"./$":35,"./$.collection":22,"./$.collection-weak":21,"./$.redef":40}],88:[function(require,module,exports){
'use strict';
...
},{"./$.collection":22,"./$.collection-weak":21}],89:[function(require,module,exports){
'use strict';
var $def      = require('./$.def')
...
},{"./$.array-includes":14,"./$.def":24,"./$.unscope":52}],90:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Map');
},{"./$.collection-to-json":20}],91:[function(require,module,exports){
...
},{"./$":35,"./$.def":24,"./$.own-keys":38}],92:[function(require,module,exports){
// http://goo.gl/XkBrjD
var $    = require('./$')
  , $def = require('./$.def');
...
},{"./$":35,"./$.def":24}],93:[function(require,module,exports){
...
},{"./$.def":24,"./$.replacer":41}],94:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
require('./$.collection-to-json')('Set');
},{"./$.collection-to-json":20}],95:[function(require,module,exports){
...
},{"./$.def":24,"./$.string-at":46}],96:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
...
},{"./$.def":24,"./$.string-pad":47}],97:[function(require,module,exports){
'use strict';
var $def = require('./$.def')
  , $pad = require('./$.string-pad');
$def($def.P, 'String', {
...
},{"./$.def":24,"./$.string-pad":47}],98:[function(require,module,exports){
...
},{"./$":35,"./$.ctx":23,"./$.def":24}],99:[function(require,module,exports){
...
},{"./$":35,"./$.iter":34,"./$.wks":53,"./es6.array.iterator":60}],100:[function(require,module,exports){
var $def  = require('./$.def')
  , $task = require('./$.task');
$def($def.G + $def.B, {
...
},{"./$.def":24,"./$.task":49}],101:[function(require,module,exports){
...
},{"./$":35,"./$.def":24,"./$.invoke":30,"./$.partial":39}],102:[function(require,module,exports){
require('./modules/es5');
...
},{"./lib/babel/api/register/node-polyfill":12}],105:[function(require,module,exports){
module.exports = require("babel-core/register");

},{"babel-core/register":104}],106:[function(require,module,exports){
...
},{"./impl/buffers":113,"./impl/channels":114,"./impl/process":116,"./impl/select":117,"./impl/timers":118}],110:[function(require,module,exports){
"use strict";
...
},{"./csp.core":109,"./csp.operations":111,"./csp.pipeline":112}],111:[function(require,module,exports){
"use strict";
...
},{"./csp.core":109,"./impl/channels":114}],112:[function(require,module,exports){
'use strict';
...
},{"./csp.core":109}],113:[function(require,module,exports){
"use strict";
...
},{"./buffers":113,"./dispatch":115}],115:[function(require,module,exports){
"use strict";
...
},{"./buffers":113}],116:[function(require,module,exports){
"use strict";
...
},{"./channels":114,"./dispatch":115,"./select":117}],117:[function(require,module,exports){
"use strict";
...
},{"./channels":114}],118:[function(require,module,exports){
"use strict";
